...
<body>
    ...
    <div id="wrap">
        ...
        <div class="container">
            ...
            <h1>
                <span class="small">Packing App <span class="yellow">.</span></span>
			...
			<?php else :  ?>
				<div class="message-wrapper">
					<p style="margin-bottom:100px;">The system is temporarily unavailable. <br> Our team is currently updating the system.</p>
				</div>
			<?php endif ?>
