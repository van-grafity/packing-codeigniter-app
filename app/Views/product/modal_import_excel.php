...
<div class="modal fade" id="modal_import_excel" tabindex="-1" role="dialog" aria-labelledby="ModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <form action="<?= base_url('product/importexcel')?>" method="post" id="packinglist_form" enctype="multipart/form-data">
                <?= csrf_field(); ?>
                <div class="modal-header">
                    <h5 class="modal-title" id="ModalLabel">Add Product via Import Excel</h5>
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group">
                                <label for="exampleInputFile">Upload Products on Excel Format</label>
                ...
                <div class="modal-footer">
                    ...
                    <button type="submit" class="btn btn-success" id="btn_submit_form">Upload Product</button>
                </div>
            </form>
        </div>
    </div>
