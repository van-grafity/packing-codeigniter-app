                            ...
                            <div class="form-group">
                                ...
                                <select id="product" class="form-control">
                                    ...
                                    <?php foreach ($products as $key => $product) { ?>
                                        <option value="<?= esc($product->id) ?>" data-product-name="<?= esc($product->product_name) ?>" data-colour="<?= esc($product->colour) ?>" data-style="<?= esc($product->style) ?>" data-size="<?= esc($product->size) ?>" data-category="<?= esc($product->category) ?>" data-price="<?= esc($product->product_price) ?>"><?= esc($product->product_code) ?>
                                        </option>
                                    <?php } ?>
                                </select>
                            </div>
...
<script type="text/javascript">
    ...
    function is_product_already_added() {
        var product_on_carton = $("input[name='products_in_carton[]']").map(function() {
            return $(this).val();
        }).get();
    ...
    function update_total_pcs() {
        let qty_per_product = $("input[name='products_in_carton_qty[]']").map(function() {
            return $(this).val();
        }).get();
